...
impl wasip3::exports::http::handler::Guest for LeptosServer {
    async fn handle(request: Request) -> Result<Response, ErrorCode> {
        ...
        let wasi_res = Handler::build(req)
            ...
            .with_server_fn::<RequestMagicLink>()
            .with_server_fn::<LoginViaMagicLink>()
            .with_server_fn::<LoginWithPassword>()
            .with_server_fn::<RegisterWithPassword>()
            .with_server_fn::<SetReferralCookieSsr>()
            .with_server_fn::<Logout>()
            .with_server_fn::<GetUserDashboardStatus>()
            .with_server_fn::<GetActiveSessions>()
            .with_server_fn::<RevokeSession>()
            .with_server_fn::<RevokeOtherSessions>()
            .with_server_fn::<AwardPoints>()
            .with_server_fn::<RegisterPasskeyStart>()
            .with_server_fn::<RegisterPasskeyFinish>()
